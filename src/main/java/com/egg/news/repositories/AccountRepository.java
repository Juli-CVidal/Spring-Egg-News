...
public interface AccountRepository extends JpaRepository<Account, String> {
    ...
    @Query("SELECT a FROM Account a WHERE a.id = :id AND a.accountType = com.egg.news.enums.Roles.JOURNALIST")
    public Account searchJournalistById(@Param("id") String id);

    @Query("SELECT a FROM Account a WHERE a.id = :id AND a.accountType = com.egg.news.enums.Roles.ADMIN")
    ...
    @Query("SELECT a FROM Account a WHERE a.accountType = com.egg.news.enums.Roles.JOURNALIST")
    public List<Account> getAllJournalists();

    @Query("SELECT a FROM Account a WHERE a.accountType = com.egg.news.enums.Roles.ADMIN")
